...
<html lang="en" class="o⋄top-container">
	<head>
		...
		<style>/************** excerpt from @offirmo-private/view-css *******/
			.o⋄top-container {
				display: flex;
...
window.addEventListener('unhandledrejection', function (evt) {
  ...
  /*const err = evt.reason || new Error('Error: uncaught promise rejection!')
	...
	<body class="o⋄body⁚full-page o⋄top-container">
    ...
    if (candidate_lc === 'anonymous' || candidate_lc === 'new player' || candidate_lc === 'new user') {
      ...
      let anon_uuid = (() => {
        ...
        try {
          ...
          if (candidate && candidate.length === anon_uuid.length) return candidate;
